  ...
  <div id="nt_content">
          ...
          <div class="col-lg-2 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__2 tc">
            <div class="product-inner pr">
              <div class="product-image pr oh lazyload">
                ...
                <a class="db" href=" {{ route('categoryproductsen', $category->category_slug_en) }}">
              ...
              <div class="product-info mt__15">
                <h3 class="product-title pr fs__14 mg__0 fwm">
                  <a class="cd chp" href="{{ route('categoryproductsen', $category->category_slug_en) }}">{{ $category->category_name_en }}</a>
                </h3>
              </div>
            </div>
          </div>
        ...
        <div class="tab_se_wrap">
          <div class="tab_se_header tc mt__30">
            <ul class="tab_cat_title ul_none des_tab_10">
              ...
              <li class="dib">
                <a class="js_t4_tab tt_active" data-bid="all" href="#"><span>{{ 'All' }}</span></a>
              </li>

              @foreach ($categories as $category)
              @if (count($category->products) > 0)
              <li class="dib">
                <a class="js_t4_tab" data-bid="category-{{ $category->id }}" href="#"><span>{{ $category->category_name_en }}</span></a>
              </li>
              @endif
              @endforeach
            </ul>
    ...
    <div class="kalles-section nt_section type_featured_collection tp_se_cdt">
      <div class="kalles-electronic-vertical__bestseller container">
        <div class="row al_center fl_center title_10">
          <div class="col-auto col-md">
            <h3 class="dib tc section-title fs__24">{{  'Hot Deals' }}</h3>
